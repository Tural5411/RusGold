...
namespace RusGold.Mvc.Controllers
{
    public class ProductController : Controller
    {
        ...
        [Route("Produkt")]
        [HttpGet]
        public async Task<IActionResult> Index(int? categoryId,int currentPage = 1, int pageSize = 50, bool isAscending = true)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> Search(string keyword, int currentPage = 1, int pageSize = 50, bool isAscending = false)
        {
