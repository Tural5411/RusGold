...
namespace RusGold.Mvc.Areas.Admin.Controllers
{
    ...
    public class CreditsController : BaseController
    {
        ...
        public CreditsController(ICarBrendModelService carbrendModelService,ICreditService creditService, IToastNotification toastNotification, UserManager<User> userManager, IMapper mapper, IImageHelper imageHelper) : base(userManager, mapper, imageHelper)
        {
